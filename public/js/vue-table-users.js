        ...
        var vm = new Vue({
          ...
          events: {
            'vuetable:action': function(action, data) {
                    ...
                    if (action == 'edit-item') 
                    {
                        var win = window.open('/users/editar/'+data.id,"_self");
                        win.focus();
                    } 
                    ...
                    {   
                        Swal.fire({
                            title: 'Estas Seguro?',
                            text: "El usuario y sus publicaciones quedaran eliminados.",
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                ...
                                instance.$http.get('/users/eliminar/'+data.id).then(response => {
