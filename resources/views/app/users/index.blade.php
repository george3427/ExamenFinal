...
<div id="app">
    ...
    <div class="container">
        ...
        <h1 class="mt-4">Usuarios en el Sistema</h1>

        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a href="{{ url("/users/nuevo") }}" class="btn btn-primary me-md-2" type="button"><i class="fas fa-user fa-plus"></i> Agregar Nuevo</a>
        </div>
...
<script src="{{asset('js/vue-table-users.js')}}"></script>
